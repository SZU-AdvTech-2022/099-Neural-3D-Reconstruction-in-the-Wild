...
if __name__ == '__main__':
    ...
    R = mesh.get_rotation_matrix_from_xyz((-np.pi/4, np.pi, np.pi))#绕y轴旋转-180°
    ...
    # 可视化
    while True:
        R = mesh.get_rotation_matrix_from_xyz((0, np.pi / 64, 0))  #
        mesh.rotate(R, center=(0, -2, 1))
